jQuery( function( $ ) {
	...
	checkoutForm.on( 'submit', function( e ) {
		const orderBtnText = $( '.mlwoo--place-order-text' );
		const orderBtnSpinner = $( '.mlwoo--place-order-spinner' );
						...
						try {
							...
							if ( 'success' === result.result && $form.triggerHandler( 'checkout_place_order_success' ) !== false ) {
								...
								if ( -1 === result.redirect.indexOf( 'https://' ) || -1 === result.redirect.indexOf( 'http://' ) ) {
									...
									// window.location = 'https://mobilouddev.wpengine.local/shop';
									if ( 'undefined' !== typeof nativeFunctions ) {
										nativeFunctions.handleLink( result.redirect, 'Order Successful', 'native' );
									} else {
										console.log( 'native functions can only run within the App.' )
									}
								} else {
									console.log('t3')
